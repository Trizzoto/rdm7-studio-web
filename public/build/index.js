...
var ASM_CONSTS = {
 ...
 623030: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 623113: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 623182: () => { return window.innerWidth; },  
 623212: () => { return window.innerHeight; }
};
